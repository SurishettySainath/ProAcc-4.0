...
class PmTask_Delete {
	...
	public void user_should_navigate_to_PmTask_Creation_page() {
		try{
			...
			loginfo= extent.createTest(Feature.class,"PmTask Deletion");
			loginfo=loginfo.createNode(Scenario.class,"PmTask Deletion");

			loginfo.createNode(new GherkinKeyword("Given"), "User should navigate to PmTask Creation page").pass("pass");
			Assert.assertTrue(true);
			loginfo.assignCategory("PmTask Delete")
	...
	public void user_has_to_enter_PmTaskname_in_search_box(String PmTaskname) {
		try{
			WebUI.delay(2)
			WebUI.click(findTestObject('Object Repository/Pro_Acc_Deletion/PmTask/btn_src'))
			WebUI.setText(findTestObject('Object Repository/Pro_Acc_Deletion/PmTask/btn_src'), PmTaskname)
	...
	public void user_has_to_click_on_delete_button_for_PmTask() {
		try{
			WebUI.delay(2)
			WebUI.click(findTestObject('Object Repository/Pro_Acc_Deletion/PmTask/btn_dlt'))
