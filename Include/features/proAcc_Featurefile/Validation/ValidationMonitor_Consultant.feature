...
# Last Updated By:
# Last Updated On:
# Feature Name: Assessment Monitor for Consultant
# Feature Description: To add the details for Assessment Monitor for Consultant
#---------------------------------------------------------------------------------------------------------------------------------
Feature: Assessment Monitor for Consultant
  ...
  Scenario Outline: Login to application
    ...
    Examples: 
      | username                                 | password                          |
      | GlobalVariable.userconsultant_Functional | GlobalVariable.passwordconsultant |

  @SmokeTest
  Scenario Outline: Assessment Monitor functionality for Consultant
    Given User is on Monitor page for Consultant<Phases>
    ...
    And User has to edit task<EstDurationConsultant>,<ActDurationConsultant>,<NoteConsultant> for consultant
    Then User should select instance successfully for Assessment Monitor Consultant

    Examples: 
      | CustomernameforAssessmentConsultant | ProjectnameforAssessmentConsultant | InstancenameforAssessmentConsultant | EstDurationConsultant | ActDurationConsultant | NoteConsultant   | Phases     |
      | Alexa Test                          | Alexa Pilot Phase Test             | A01                                 |                     3 |                     5 | Work In Progress | Validation |
