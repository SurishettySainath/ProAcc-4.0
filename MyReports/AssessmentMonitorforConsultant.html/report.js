$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/proAcc_Featurefile/Assessment/AssessmentMonitor_Consultant.feature");
formatter.feature({
  "name": "Assessment Monitor for Consultant",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "User is on Consultant Monitor pageAssessment",
  "keyword": "Given "
});
formatter.match({
